 ...
 */
public class PowerShellStartScriptTemplate extends StartScript.SimpleTemplate {
    private static final String TEMPLATE_RESOURCE_PATH = "start-template.ps1";
    ...
    private static final String STAT_FORMAT = "%s";
    ...
    private static final String COPY_SUPPORTED = "Use a timestamp preserving copy option " + NO_CDS;

    /**
     * Constructor.
     */
    public PowerShellStartScriptTemplate() {
    ...
    public String render(TemplateConfig config) {
        ...
        replace(STAT_FORMAT_VAR, STAT_FORMAT);
